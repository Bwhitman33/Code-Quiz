...
const questions = [
    ...
    {
        question: 'Which of the below is the correct syntax to underline text in CSS??',
        answers: [
    ...
    {
        question: 'Which of the following functions of an Array object returns a string representing the array and its elements??',
        answers: [
